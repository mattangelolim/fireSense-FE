          ...
          <div className="flex flex-col justify-center items-center">
            <div className="video border-solid border-2 border-orange-600">
              <iframe
                ...
                frameborder="0"
                allowfullscreen
                src="https://demo.nanocosmos.de/nanoplayer/embed/1.3.3/nanoplayer.html?group.id=05e47c94-fb92-42f0-a376-7ddd453757aa&options.adaption.rule=deviationOfMean2&startIndex=0&playback.latencyControlMode=classic"
              ></iframe>
            </div>
            {shouldRenderH3 && (
              <h3
